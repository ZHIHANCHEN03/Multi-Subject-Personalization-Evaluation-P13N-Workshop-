...
The core of our benchmark is a set of carefully crafted evaluation prompts designed to test both scalability and spatial reasoning. We define five distinct difficulty levels based on the subject count: \textbf{2, 4, 6, 8, and 10 subjects}. 
