...
*(Placeholder: Figure 2 (Benchmark Design). Insert a diagram illustrating the benchmark construction process. It should show the pool of subjects on the left, the combination into prompts of varying lengths (2 to 10) in the middle, and the three scene types (Neutral, Occlusion, Interaction) on the right.)*
