...
In this section, we present the quantitative and qualitative results of our evaluation. We benchmark three state-of-the-art multi-subject personalization models: **MOSAIC** [5], **XVerse** [6], and **PSR** [7], across five difficulty levels ranging from 2 to 10 interacting subjects.
...
<!-- 
=========================================
TABLE 1 PLACEHOLDER (QUANTITATIVE RESULTS)
=========================================
\begin{table*}[t]
\centering
...
<!-- 
=========================================
FIGURE 2 PLACEHOLDER (LINE CHARTS)
=========================================
\begin{figure*}[t]
  \centering
...
The most striking finding from our benchmark is the catastrophic collapse of identity fidelity when scaling beyond 4 subjects. As shown in the DINOv2 scores, all models experience a precipitous drop. For instance, MOSAIC [5], which performs best at the 2-subject level with a DINOv2 score of 0.424, plummets to 0.110 at 10 subjects. XVerse [6] and PSR [7] follow a nearly identical trajectory, dropping from 0.355 and 0.324 to ~0.10, respectively. 
...
<!-- 
=========================================
FIGURE 3 PLACEHOLDER (QUALITATIVE RESULTS)
=========================================
\begin{figure*}[t]
  \centering
  \includegraphics[width=\textwidth]{figures/qualitative_failures.pdf}
